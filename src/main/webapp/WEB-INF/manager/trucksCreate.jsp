        ...
        <div class="row">
            <div class="col-md-6">
                <div class="box">
                    ...
                    <form role="form" action="/page/manager/trucks/edit" method="post">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input id="inputReg" type="text" pattern="[A-Z]{2}[0-9]{5}" class="form-control" value="" name="regNumber" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input id="inputCapacity" type="number" min="1" class="form-control" value="" name="capacity" required>
                            </div>
                            <div class="form-group">
                                <label for="inputCount">Driver count</label>
                                <input id="inputCount" type="number" min="1" class="form-control" value="" name="driverCount" required>
                            </div>
                            <div class="form-group">
