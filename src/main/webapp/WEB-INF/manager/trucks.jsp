                ...
                <div class="col-md-2">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Select trucks from city</h3>
                        </div><!-- /.box-header -->
                        <form role="form" action="/page/manager/trucks" method="get">
                            <div class="box-body">
                                ...
                                <c:forEach var="truck" items="${truckList}">
                                    <tr>
                                        ...
                                        <td>${truck.currentCity.name}</td>
                                         <td>${truck.currentOrder.id}</td>
                                        <td><a href="/page/manager/trucks/edit?id=${truck.id}">edit</a></td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
