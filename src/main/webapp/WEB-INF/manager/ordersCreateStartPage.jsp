...
<head>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Order creation. Select start city and cargo for order
            </h1>
        </section>
                ...
                <div class="col-md-2">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Start city</h3>
                        </div><!-- /.box-header -->
                        <form role="form" action="/page//manager/orders/createStart" method="get">
                            <div class="box-body">
                ...
                <div class="col-md-10">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Select cargo from ${currentCity.name}</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <c:forEach var="truck" items="${truckList}">
                                    <tr>
                                        ...
                                        <td>
                                            <form action="/page/manager/orders/create" method="post">
                                                <input type="hidden" name="truckId" value="${truck.id}">
                                                <input type="hidden" name="cityId" value="${currentCity.id}">
                                                <button type="submit" name="action" value="chooseCargo" class="btn btn-block btn-primary btn-xs">Choose</button>
                                            </form>
                                        </td>
                                    </tr>
                                </c:forEach>
