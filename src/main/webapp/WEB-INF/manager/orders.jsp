                ...
                <div class="col-md-2">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Select start city</h3>
                        </div><!-- /.box-header -->
                        <form role="form" action="/page/manager/orders" method="get">
                            <div class="box-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <c:forEach var="order" items="${orderList}">
                                    <tr>
                                        ...
                                        <td>${order.startCity.name}</td>
                                        <td>${order.status}</td>
                                        <td><a href="/page/manager/orders/cargos?orderId=${order.id}">cargos</a></td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
